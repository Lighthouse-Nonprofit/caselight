  ...
  class Registry
    ...
    REGISTRY = {
      ...
      'youth' => WORKER_PACK + MANAGER_PACK + [
        ...
        Definition.new(slug: 'program-session-attendance', klass_name: 'Reports::Youth::ProgramSessionAttendance',
                       audience: :leadership,
                       presets: %i[sfy_quarter term eyc_half calendar_year custom]),
        Definition.new(slug: 'school-attendance', klass_name: 'Reports::Youth::SchoolAttendance',
                       audience: :leadership,
                       presets: %i[sfy_quarter term eyc_half calendar_year custom]),
