class CustomField < ActiveRecord::Base
  ...
  # Phase 5.2 (NIST AC family) — per-FORM sensitivity classification; the masking unit is
  # custom_field_id, mixed forms are SPLIT. Vocabulary + validation + scopes live in the shared
  # Sensitizable concern; SensitivityPolicy owns the need-to-know matrix.
