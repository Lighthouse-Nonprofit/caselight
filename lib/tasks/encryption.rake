...
namespace :encryption do
  ...
  ENCRYPTION_TIERS = {
    '1' => {
      ...
      # UX round 3 (B2/B3): FamilyNote/FamilyAlert are born-encrypted (no plaintext rows exist
      # to backfill) but register here so encryption:verify covers them and the registry drift
      # guard stays green.
