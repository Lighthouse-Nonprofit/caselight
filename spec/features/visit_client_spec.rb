  ...
  feature 'Client show page' do
    feature 'from clients list/index' do
      ...
      scenario 'increase visit client by 1' do
        # slug-prefix match: client_path here carries ?locale=en (spec default_url_options)
        # while the results-grid hrefs do not
        first(%(a[href^="/clients/#{client_1.slug}"])).click
